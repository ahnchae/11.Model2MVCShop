			...
			//==> DOM Object GET 3가지 방법 ==> 1. $(tagName) : 2.(#id) : 3.$(.className)
			 ...
			 $("#password2").on("keyup", function(){
				 ...
				 if(($("#password2").val())==($("#password").val())){
					...
					$("#passwordMessage").text('비밀번호와 비밀번호 확인이 일치합니다.')
				 }else{
					 //alert("비밀번호와 비밀번호 확인이 일치하지 않습니다.")
					// console.log($("form table[style] tr:nth-child(6) td:last").html())
					$("#passwordMessage").empty()
					$("#passwordMessage").text('비밀번호와 비밀번호 확인이 일치하지 않습니다.')
				 }
			 })
		});	
	...
	<div class="container">
		...
		<form class="form-horizontal">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="userId" name="userId" placeholder="사용하실 아이디를 입력하세요" >
		       <span id="helpBlock" class="help-block">
		      	<strong class="text-danger" id="idMessage"></strong>
		      </span>
		    </div>
<!-- 		<div class="col-sm-3">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      ...
		      <span id="helpBlock" class="help-block">
		      	<strong class="text-danger" id="passwordMessage"></strong>
		      </span>
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      ...
		      <span id="helpBlock" class="help-block">
		      	 <em class="text-primary">" -  " 제외 13자리입력하세요</em>
		      </span>
		    </div>
		  </div>
